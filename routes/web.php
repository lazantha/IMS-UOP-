...
// Route::post('templates/', [SignUp::class, 'signUp'])->name('sign-up');
Route::post('templates/sign-up', [AdminController::class, 'signUp'])->name('sign-up');
Route::post('templates/sign-in', [AdminController::class, 'signIn'])->name('sign-in');
